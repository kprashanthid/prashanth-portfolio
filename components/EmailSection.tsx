  ...
  return (
    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#10161a] mb-4 max-w-md">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="github.com">
            <Image className="h-20 w-20 mr-10" src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="linkedin.com">
            <Image className="h-20 w-20" src={LinkedinIcon} alt="Linkedin Icon" />
          </Link>
        </div>
      </div>
      <div>
